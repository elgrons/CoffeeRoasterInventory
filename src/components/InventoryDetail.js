  ...
  return (
    <React.Fragment>
      <Container>
        <Row>
      <Col sm={5}>
      <br /><h2>Inventory Details</h2><br />
      <h3><strong> Name:</strong> {inventory.name}</h3><br />
      <li><strong>Origin:</strong> {inventory.origin} ☕️ <strong>Roast:</strong> {inventory.roast} </li><br />
